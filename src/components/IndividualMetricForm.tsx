      ...
      if (existingData) {
        ...
        const { error } = await supabase
          ...
          .insert({
            ...
            burn_rate_technology: metric.id === 'burn_rate_technology' ? parsedValue : 0,
            burn_rate_salaries: metric.id === 'burn_rate_salaries' ? parsedValue : 0,
            burn_rate_ferramentas: metric.id === 'burn_rate_ferramentas' ? parsedValue : 0,
            burn_rate_prolabore: metric.id === 'burn_rate_prolabore' ? parsedValue : 0,
            burn_rate_marketing: metric.id === 'burn_rate_marketing' ? parsedValue : 0,
            burn_rate_administrative: metric.id === 'burn_rate_administrative' ? parsedValue : 0,
            burn_rate_others: metric.id === 'burn_rate_others' ? parsedValue : 0,
